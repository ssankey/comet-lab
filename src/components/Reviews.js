    ...
    <div className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="items-end justify-between sm:flex">
            <div className="max-w-xl text-center mx-auto">
                <h2 className="text-lg font-bold  tracking-widest text-[#00c2c5ff]">
                    Don't Just Take Our Word For It
                </h2>
            </div>
        </div>
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 sm:p-12">
        <Fade cascade direction='up' damping={0.1} triggerOnce>
            <blockquote className="flex h-full flex-col justify-between p-8">
                <div>
                    <div className="flex gap-0.5 text-[#00c2c5ff]">
                        <svg
